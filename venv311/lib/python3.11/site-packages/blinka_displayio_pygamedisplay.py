...
_DISPLAYIO_EVENTS = _PYGAME_REDRAW_EVENTS + [
    _DISPLAYIO_EVENT,
    pygame.QUIT,
    pygame.WINDOWCLOSE,
]
...
class PyGameDisplay(busdisplay.BusDisplay):
    ...
    def _refresh_area(self, area) -> bool:
        ...
        def rgb_to_surface(buff, size):
            ...
            # NumPy 2.0 removed binary mode in fromstring; use frombuffer instead
    ...
    def check_quit(self, delay=0.05):
        ...
        try:
            do_refresh = False
            for event in pygame.event.get(eventtype=_DISPLAYIO_EVENTS):
                if (
    ...
    def event_loop(
        ...
        while True:
            do_refresh = False
            for event in pygame.event.get(eventtype=_DISPLAYIO_EVENTS + events):
